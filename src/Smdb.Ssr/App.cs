...
public class App : HttpServer
{
	...
	public override void Init()
	{
		...
		var userRepository = new MySqlUserRepository("Server=localhost;Port=3306;Database=simplemdb;Uid=root;Pwd=8S18Qg$P0[3Zj+s4+3;");
		...
		var actorRepository = new MySqlActorRepository("Server=localhost;Port=3306;Database=simplemdb;Uid=root;Pwd=8S18Qg$P0[3Zj+s4+3;");
		...
		var movieRepository = new MySqlMovieRepository("Server=localhost;Port=3306;Database=simplemdb;Uid=root;Pwd=8S18Qg$P0[3Zj+s4+3;");
		...
		var actorMovieRepository = new MySqlActorMovieRepository("Server=localhost;Port=3306;Database=simplemdb;Uid=root;Pwd=8S18Qg$P0[3Zj+s4+3;");
